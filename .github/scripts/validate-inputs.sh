...
for name in AB_PARTITION DISABLE_LTO_REQUESTED INTEGRATE_SUSFS INTEGRATE_DROIDSPACES PACKAGE_AK3; do case "${!name:-false}" in true|false) ;; *) die "$name must be true or false" ;; esac; done
